    ...
    <footer class="nav-footer" id="footer">
      <section class="sitemap">
        ...
        <div>
          ...
          <a href="hhttps://discuss.4d.com/">4D Forum</a>
          ...
          <a href="https://github.com/4d-go-mobile">GitHub</a>
        </div>
        <div>
          <h5>Support</h5>
          <a href="hhttps://developer.4d.com/docs/">4D Documentation</a>
          <a href="https://doc.4d.com/">4D Doc Center (Legacy)</a>
      ...
      <section class="copyright">© 2022 4D SAS - All rights reserved</section>
